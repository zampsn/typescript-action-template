...
describe('github-token', () => {
    it('Should return the input token', () => {
        ...
        expect(core.getInput).toHaveBeenCalledWith(Inputs.GITHUB_TOKEN, {trimWhitespace: true})
    })
...
describe('repository', () => {
    ...
    it('Should return the repository input', () => {
        ...
        expect(core.getInput).toHaveBeenCalledWith(Inputs.REPOSITORY, {trimWhitespace: true})
    })
